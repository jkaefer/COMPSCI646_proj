...
## complex_searcher: This agent can help decide whether the main question should be split into multiple simpler sub-questions that. It then uses either the main question or sub-questions in a search for information to help answer the main question. You are required to use this agent once and only once at some point in the task in order to find documents that help answer the question.
### input:
